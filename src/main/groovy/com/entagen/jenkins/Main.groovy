...
class Main {
    public static final Map<String, Map<String, Object>> opts = [
            ...
            i: [longOpt: 'filter-branches-inactive-since', required: false, args:  1, argName:  'filterBranchesInactiveSince', description: "Only branches active since the specified date (git-log --since compatible) - gradle flag: -DfilterBranchesInactiveSince=<date>"],
